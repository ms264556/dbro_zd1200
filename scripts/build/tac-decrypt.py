#!/usr/bin/env python3
"""Decrypt a Ruckus TAC-format firmware archive.

The firmware upgrade files downloaded from Ruckus/CommScope are TAC-encrypted;
this turns one into the gzip-TAR payload the rest of the tooling consumes.  It
